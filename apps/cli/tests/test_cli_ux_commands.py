...
import ralphite_cli.checks.suites as suite_mod
import ralphite_cli.commands.check_cmd as check_mod
import ralphite_cli.commands.quickstart_cmd as quickstart_mod
...
def test_strict_checks_include_fixture_confidence_suites(
    ...
    assert any("apps/cli/tests/test_bootstrap_e2e.py" in row for row in commands)
