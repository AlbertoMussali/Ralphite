...
STRICT_SUITES: list[tuple[str, list[str]]] = [
    (
        ...
        [
            ...
            "--no-sync",
            "pytest",
            "tests/engine/test_task_parser.py",
            "tests/engine/test_structure_compiler.py",
            "-q",
        ],
    ),
    (
        ...
        [
            ...
            "--no-sync",
            "pytest",
            "tests/engine/test_git_worktree_integration.py",
    ...
    (
        ...
        [
            ...
            "--no-sync",
            "pytest",
            "tests/engine/test_e2e_recovery.py",
            "-q",
        ],
    ),
    (
        ...
        [
            ...
            "--no-sync",
            "pytest",
            "tests/engine/test_fixture_plan_matrix.py",
            "tests/engine/test_dispatched_plan_consistency.py",
            "tests/engine/test_examples_plans.py",
            "tests/cli/test_bootstrap_e2e.py",
            "-q",
        ],
    ),
]
